...
import { MessageCircle, Clock, Brain, BookOpen, ClipboardCheck, LayoutDashboard, Sparkles, Shield, Zap, ArrowRight } from 'lucide-react';
import { trackPageView } from '../services/analytics';
import { useEffect } from 'react';
import './pages.css';

const features = [
  { icon: MessageCircle, title: 'AI Assistant', desc: 'Ask anything about elections powered by Google Gemini AI', path: '/chat', color: '#FF6B35' },
  { icon: Clock, title: 'Election Timeline', desc: 'Interactive 9-stage walkthrough of the election process', path: '/timeline', color: '#F7C948' },
  { icon: Brain, title: 'Knowledge Quiz', desc: 'Test your understanding with 25+ categorized questions', path: '/quiz', color: '#3B82F6' },
  { icon: BookOpen, title: 'Encyclopedia', desc: 'Searchable glossary of election terms and concepts', path: '/encyclopedia', color: '#8B5CF6' },
  { icon: ClipboardCheck, title: 'Voter Checklist', desc: 'Step-by-step guide to voter registration and readiness', path: '/checklist', color: '#1DB954' },
  { icon: LayoutDashboard, title: 'Dashboard', desc: 'Track your learning progress and achievements', path: '/dashboard', color: '#06B6D4' },
];
    ...
    <div className="home-page">
      ...
      <section className="hero" role="banner">
        ...
        <div className="hero-content animate-fade-in-up">
          ...
          <h1 className="hero-title">
            ...
            <span className="gradient-text-tricolor">One Step at a Time</span>
          </h1>
          <p className="hero-subtitle">
            NirvachAI is your intelligent guide to the Indian election process.
      ...
      <section className="home-stats" aria-label="Platform statistics">
        <div className="home-stats-grid">
          {[
            ...
            <div key={i} className={`home-stat animate-fade-in-up stagger-${i + 1}`}>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-content">
          <div className="footer-brand gradient-text-tricolor">🗳️ NirvachAI</div>
          <p className="footer-text">Empowering citizens through election education</p>
          <div className="footer-links">
            <a href="https://eci.gov.in" target="_blank" rel="noopener noreferrer" className="footer-link">ECI Website</a>
            <a href="https://voters.eci.gov.in" target="_blank" rel="noopener noreferrer" className="footer-link">Voter Portal</a>
            <a href="https://ecisveep.nic.in" target="_blank" rel="noopener noreferrer" className="footer-link">SVEEP</a>
          </div>
          <p className="footer-disclaimer">
            ⚠️ NirvachAI is an educational tool and not an official ECI product. Always verify information
